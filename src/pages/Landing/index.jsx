...
const Landing = () =>{
    return(
        <>
        <LayoutHeader/>
        <div style={{ background: '#B9F0FC', padding: '60px', height:'100vh'}}>
            <div style={{position:'relative', top:'50%',left:'50%', transform: 'translate(-50%,-50%)', display:'flex',flexDirection:'column', width:'fit-content', textAlign:'center'}}>
